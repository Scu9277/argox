...
echo "$vl_xh_link"
echo
echo "      - ${name:-vl-xhttp-reality-$hostname}" >> "$HOME/agsbx/proxy_names.txt"
cat >> "$HOME/agsbx/clash.yaml" <<EOF
...
echo "$vl_vx_cdn_link"
echo
echo "      - ${name:-vl-xhttp-cdn-$hostname}" >> "$HOME/agsbx/proxy_names.txt"
cat >> "$HOME/agsbx/clash.yaml" <<EOF
...
cat >> "$HOME/agsbx/clash.yaml" <<EOF
  - name: ${name:-vl-xhttp-$hostname}
    ...
    xhttp-opts:
      ...
      path: /$uuid-vx
EOF
echo "      - \"${name:-vl-xhttp-$hostname}\"" >> "$HOME/agsbx/proxy_names.txt"
fi
...
echo "$vl_vw_cdn_link"
echo
echo "      - ${name:-vl-ws-enc-cdn-$hostname}" >> "$HOME/agsbx/proxy_names.txt"
cat >> "$HOME/agsbx/clash.yaml" <<EOF
...
cat >> "$HOME/agsbx/clash.yaml" <<EOF
  - name: ${name:-vl-ws-enc-$hostname}
    ...
    ws-opts:
      path: /$uuid-vw
EOF
echo "      - \"${name:-vl-ws-enc-$hostname}\"" >> "$HOME/agsbx/proxy_names.txt"
fi
...
echo "$vl_link"
echo
echo "      - ${name:-vl-reality-vision-$hostname}" >> "$HOME/agsbx/proxy_names.txt"
cat >> "$HOME/agsbx/clash.yaml" <<EOF
...
echo "$ss_link"
echo
echo "      - ${name:-Shadowsocks-2022-$hostname}" >> "$HOME/agsbx/proxy_names.txt"
cat >> "$HOME/agsbx/clash.yaml" <<EOF
...
echo "$vm_cdn_link"
echo
echo "      - ${name:-vm-ws-cdn-$hostname}" >> "$HOME/agsbx/proxy_names.txt"
cat >> "$HOME/agsbx/clash.yaml" <<EOF
  ...
  - name: ${name:-vm-ws-$hostname}
    ...
    ws-opts:
      ...
      headers:
        Host: www.bing.com
EOF
echo "      - \"${name:-vm-ws-$hostname}\"" >> "$HOME/agsbx/proxy_names.txt"
fi
...
cat >> "$HOME/agsbx/clash.yaml" <<EOF
  - name: ${name:-hy2-$hostname}
    ...
    alpn:
      - h3
EOF
echo "      - \"${name:-hy2-$hostname}\"" >> "$HOME/agsbx/proxy_names.txt"
fi
...
EOF
echo "      - \"${name:-tuic-$hostname}\"" >> "$HOME/agsbx/proxy_names.txt"
fi
...
echo "客户端密码：$uuid"
echo
echo "      - ${name:-Socks5-$hostname}" >> "$HOME/agsbx/proxy_names.txt"
cat >> "$HOME/agsbx/clash.yaml" <<EOF
...
echo "      - ${name:-vmess-ws-tls-argo-$hostname-443}" >> "$HOME/agsbx/proxy_names.txt"
cat >> "$HOME/agsbx/clash.yaml" <<EOF
...
echo "      - ${name:-vless-ws-tls-argo-enc-vision-$hostname}" >> "$HOME/agsbx/proxy_names.txt"
cat >> "$HOME/agsbx/clash.yaml" <<EOF
...
echo "      - ${name:-vless-ws-argo-enc-vision-$hostname}" >> "$HOME/agsbx/proxy_names.txt"
cat >> "$HOME/agsbx/clash.yaml" <<EOF
...
echo "  - name: ${name:-Proxy-Group}" >> "$HOME/agsbx/clash.yaml"
